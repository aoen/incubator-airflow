...
class WebUiTests(unittest.TestCase):
    ...
    def test_dag_views(self):
        ...
        url = (
            ...
            "dag_id=example_bash_operator&ignore_ti_state=true&deps=true&"
    ...
    def test_presto_to_mysql(self):
        ...
        def test_hive_to_mysql(self):
            t = operators.HiveToMySqlTransfer(
                ...
                dag=self.dag)
            t.clear(start_date=DEFAULT_DATE, end_date=DEFAULT_DATE).run(start_date=DEFAULT_DATE, end_date=DEFAULT_DATE, ignore_ti_state=True)
