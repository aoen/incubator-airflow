...
class MinExecContext(BaseDepContext):
    """
    ...
    def __init__(
        ...
        """
        super(MinExecContext, self).__init__(
    ...
    def get_ignoreable_deps(self, ti):
        return super(MinExecContext, self).get_ignoreable_deps(ti) | {
            NotSkippedDep(),
            RunnableExecDateDep(),
        }
    ...
    def get_nonignoreable_deps(self):
        ...
        return super(MinExecContext, self).get_nonignoreable_deps() | {
            NotRunningDep()
        }
